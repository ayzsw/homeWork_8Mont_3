...
//
    ...
    override func viewDidLoad() {
        ...
        foodImg.image = UIImage(named: (foods?.foodImg1)!)
       labelBigNameFood.text = foods?.labelBigNameFood1
       labelTime.text = foods?.labelTime1
       labelOtcenka.text = foods?.labelOtcenka1
       labelCountry.text = foods?.labelCountry1
       labelTypeFood.text = foods?.labelTypeFood1
       labelKM.text = foods?.labelKM1
        labelDelivery.text = foods?.labelDelivery1
        labelPrice.text = foods?.labelPrice1
